(window["canvasWebpackJsonp"]=window["canvasWebpackJsonp"]||[]).push([[12],{"97gy":function(e,t,n){"use strict"
...
return t.apply(this,arguments)}Object(a["a"])(n,[{key:"render",value:function(){return d.a.createElement(l["a"],Object.assign({},this.props,{name:"IconCheckMark",viewBox:"0 0 1920 1920"}),u)}}])
...
var t=Object(s["a"])(n)
function n(){Object(o["a"])(this,n)
return t.apply(this,arguments)}Object(a["a"])(n,[{key:"render",value:function(){return d.a.createElement(l["a"],Object.assign({},this.props,{name:"IconNo",viewBox:"0 0 1920 1920"}),u)}}])
...
var t=Object(s["a"])(n)
function n(){Object(o["a"])(this,n)
return t.apply(this,arguments)}Object(a["a"])(n,[{key:"render",value:function(){return d.a.createElement(I["a"],Object.assign({},this.props,{name:"IconInfoBorderless",viewBox:"0 0 1920 1920"}),j)}}])
...
var x=n("J2CL")
var A=n("BTe1")
function T(e){var t=e.colors,n=e.borders,r=e.spacing,o=e.typography,a=e.shadows
return{background:t.backgroundLightest,color:t.textDarkest,marginTop:r.small,borderRadius:n.radiusMedium,borderWidth:n.widthMedium,borderStyle:n.style,contentPadding:"".concat(r.small," ").concat(r.medium),contentFontSize:o.fontSizeMedium,contentFontFamily:o.fontFamily,contentFontWeight:o.fontWeightNormal,contentLineHeight:o.lineHeightCondensed,closeButtonMarginTop:r.xSmall,closeButtonMarginRight:r.xxSmall,iconColor:t.textLightest,successBorderColor:t.borderSuccess,successIconBackground:t.backgroundSuccess,infoBorderColor:t.borderInfo,infoIconBackground:t.backgroundInfo,warningBorderColor:t.borderWarning,warningIconBackground:t.backgroundWarning,dangerBorderColor:t.borderDanger,dangerIconBackground:t.backgroundDanger,boxShadow:a.depth2}}T.canvas=function(e){return{color:e["ic-brand-font-color-dark"]}}
var _,N,E,D,z
...
var U=(_=Object(f["a"])("8.0.0",{closeButtonLabel:"renderCloseButtonLabel"}),N=Object(x["j"])(T,W),_(E=N(E=(z=D=function(e){Object(i["a"])(n,e)
var t=Object(s["a"])(n)
function n(e){var r
Object(o["a"])(this,n)
r=t.call(this,e)
...
var o=m()((e={},Object(r["a"])(e,W.alert,true),Object(r["a"])(e,n,true),Object(r["a"])(e,W.hasShadow,this.props.hasShadow),e))
return d.a.createElement(O["a"],{as:"div",margin:this.props.margin,className:o,onKeyUp:this.handleKeyUp},this.renderIcon(),d.a.createElement("div",{className:W.content},this.props.children),this.renderCloseButton())}},{key:"render",value:function(){if(this.props.screenReaderOnly){this.getLiveRegion()
...
var p=n("XQb/")
var m
const g=Object(c["useScope"])("ajaxflashalert")
const b="flashalert_message_holder"
const f="flash_screenreader_holder"
const y=1e4
class C extends a.a.Component{constructor(e){super(e)
...
return Object(r["a"])(u["a"],{as:"p",fontStyle:"italic"},void 0,Object(r["a"])(u["a"],{},void 0,e),t?m||(m=Object(r["a"])("br",{})):null,t?Object(r["a"])(u["a"],{},void 0,t):null)}render(){let e=null
this.props.error&&(e=this.state.showDetails?this.renderDetailMessage():Object(r["a"])("span",{},void 0,Object(r["a"])(v["a"],{},void 0,Object(r["a"])(l["a"],{variant:"link",onClick:this.showDetails},void 0,g.t("Details"))),Object(r["a"])(h["a"],{},void 0,this.renderDetailMessage())))
return Object(r["a"])(p["a"],{transitionOnMount:true,in:this.state.isOpen,type:"fade"},void 0,Object(r["a"])(d["a"],{variant:this.props.variant,renderCloseButtonLabel:g.t("Close"),onDismiss:this.closeAlert,margin:"small auto",timeout:this.props.timeout,liveRegion:this.getLiveRegion,transition:"fade",screenReaderOnly:this.props.screenReaderOnly},void 0,Object(r["a"])("div",{},void 0,Object(r["a"])("p",{style:{margin:"0 -5px"}},void 0,this.props.message),e)))}}C.defaultProps={error:null,variant:"info",timeout:y,screenReaderOnly:false}
function O({message:e,err:t,type:n=(t?"error":"info"),srOnly:o=false}){function a(e){s.a.unmountComponentAtNode(e)
e.remove()}function i(){let e=document.getElementById(b)
if(!e){e=document.createElement("div")
e.classList.add("clickthrough-container")
e.id=b
e.setAttribute("style","position: fixed; top: 0; left: 0; width: 100%; z-index: 100000;")
document.body.appendChild(e)}return e}function c(i){s.a.render(Object(r["a"])(C,{message:e,timeout:Number.isNaN(parseInt(ENV.flashAlertTimeout,10))?y:ENV.flashAlertTimeout,error:t,variant:n,onClose:a.bind(null,i),screenReaderOnly:o}),i)}const d=document.createElement("div")
d.setAttribute("style","max-width:50em;margin:1rem auto;")
d.setAttribute("class","flashalert-message")
i().appendChild(d)
c(d)}function k(e=g.t("An error occurred making a network request")){return t=>O({message:e,err:t,type:"error"})}function B(e){return()=>O({message:e,type:"success"})}},znKQ:function(e,t,n){"use strict"
n.d(t,"a",(function(){return v}))
var r=n("VTBJ")
var o=n("1OyB")
var a=n("vuIU")
...
var t=Object(s["a"])(n)
function n(){Object(o["a"])(this,n)
return t.apply(this,arguments)}Object(a["a"])(n,[{key:"render",value:function(){return d.a.createElement(l["a"],Object.assign({},this.props,{name:"IconWarningBorderless",viewBox:"0 0 1920 1920"}),u)}}])
...
//# sourceMappingURL=12-c-24ad207d31.js.map